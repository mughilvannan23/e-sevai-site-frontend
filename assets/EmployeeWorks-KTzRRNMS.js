...
Thank You! 🙏`,i=`https://wa.me/91${e}?text=${encodeURIComponent(r)}`;window.open(i,`whatsapp_window`)}}}},formatDateTime:e=>e?new Date(e).toLocaleString(`en-IN`,{day:`2-digit`,month:`2-digit`,year:`numeric`,hour:`2-digit`,minute:`2-digit`,hour12:!0}).replace(/\//g,`-`).replace(/, /g,` `).replace(/am/i,`AM`).replace(/pm/i,`PM`):`-`,getStatusBadge:(e,t)=>{let n=t===`payment`,r=n?e===`Paid`:e===`Completed`;return(0,p.jsx)(`span`,{style:{...c.badge,backgroundColor:r?`var(--success-color)`:n?e===`None`?`#95a5a6`:`var(--danger-color)`:`var(--warning-color)`,color:`white`},children:t===`work`?u(e):e})},isAdmin:!1,isEmployee:!0,tableRef:r}),S.totalWorks>0&&(0,p.jsx)(`div`,{className:`p-3 d-flex justify-content-center`,children:(0,p.jsx)(l,{currentPage:S.currentPage,totalPages:S.totalPages,totalItems:S.totalWorks,itemsPerPage:S.limit,onPageChange:e=>T(t=>({...t,page:e}))})})]})};export{m as default};